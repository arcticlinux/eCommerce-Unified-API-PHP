...
print("\nRateInqStartTime = " . $mpgResponse->getRateInqStartTime(
	));  //The time (unix UTC) of when the rate is requested
print("\nRateInqEndTime = " . $mpgResponse->getRateInqEndTime());  //The time (unix UTC) of when the rate is returned
print("\nRateValidityStartTime = " . $mpgResponse->getRateValidityStartTime(
	));    //The time (unix UTC) of when the rate is valid from
print("\nRateValidityEndTime = " . $mpgResponse->getRateValidityEndTime(
	));    //The time (unix UTC) of when the rate is valid until
